...
import mbh.com.huzoolist.ui.main.Animal;
...
public final class DBHelper {
    ...
    private static final String INSERT = "INSERT INTO " + TABLE_NAME + "(" + KEY_NAME + ", " +
            KEY_LOCATION + ", " +
            KEY_TYPE + ") values (?, ?, ?)";
    ...
    public List<Animal> selectAll()
    {
        ...
        new String[] { KEY_ID, KEY_NAME, KEY_LOCATION, KEY_TYPE }, null, null, null, null, null);
